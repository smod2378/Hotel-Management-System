...
public class UpdateCheck extends JFrame implements ActionListener
{
    ...
    public UpdateCheck()
    {
        ...
        ImageIcon i1 = new ImageIcon(getClass().getResource("nine.jpg"));
        JLabel il1 = new JLabel(i1);
        il1.setBounds(400,50,500,300);
        add(il1);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==b1)
        {
            try
            {
                ...
                while(rs.next())
                {
                    t1.setText(rs.getString("allocated room"));
                    t2.setText(rs.getString("name"));
                    t3.setText(rs.getString("check_status"));
                ...
                while(rs.next())
                {
                    ...
                    t5.setText(Integer.toString(pending)); // setText, getText only accepts String parameters hence int has to be converted into S
                }
                rs.close();
                rs2.close();
                c.s.close();
